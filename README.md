...
เพื่อให้เห็นภาพความแตกต่างของ ขนาดตลาดงาน และ สัญญาณความสนใจของผู้สมัคร ในชุดข้อมูลนี้อย่างชัดเจน จึงได้ทำการเปรียบเทียบข้อมูลออกเป็น 2 กลุ่มหลัก ได้แก่ USA และ Other USA (ประเทศอื่นทั้งหมดที่ไม่ใช่ USA) โดยสรุปผลผ่าน 3 ตัวชี้วัดหลัก ได้แก่ จำนวนบริษัทที่ไม่ซ้ำ, จำนวนประกาศงานที่ไม่ซ้ำ และจำนวนการสมัครรวม (applies)

1) Count of Company (distinct): สะท้อน ความหลากหลายของผู้จ้างงาน พบว่ากลุ่ม USA มีบริษัทที่ลงประกาศงานจำนวนมากอย่างมีนัยสำคัญ (21,635 บริษัท) เมื่อเทียบกับกลุ่ม Other USA (2,839 บริษัท) แปลได้ว่า dataset นี้มีฐานผู้จ้างงานใน USA ที่กว้างและหนาแน่นกว่าอย่างชัดเจน
2) Count of Job ID (distinct): แทน จำนวนประกาศงานจริง หรือมุมของ ปริมาณตำแหน่งงานที่ถูกโพสต์ (supply) พบว่ากลุ่ม USA มีจำนวนประกาศงานสูงมาก (109,995 โพสต์) ขณะที่กลุ่ม Other USA มีเพียง (12,137 โพสต์) ผลลัพธ์นี้ช่วยยืนยันว่า น้ำหนักของข้อมูล และขนาดตลาดงานใน dataset ชุดนี้กระจุกตัวที่ USA เป็นหลัก ซึ่งเป็นเหตุผลสำคัญที่โฟกัสการวิเคราะห์เชิงลึกใน USA ต่อไป
3) Sum of Applies: เป็นเชิงพฤติกรรม (engagement) ของผู้สมัครต่อประกาศงาน จากกราฟพบว่ากลุ่ม USA มีจำนวนการสมัครรวมสูงกว่าอย่างชัดเจน (211,680 ครั้ง) เมื่อเทียบกับกลุ่ม Other USA (30,034 ครั้ง) สะท้อนว่าในข้อมูลชุดนี้ ไม่เพียงแต่ USA มีประกาศงานมากกว่า แต่ยังมี “การตอบสนองของผู้สมัคร” ที่สูงกว่าด้วย

สรุป: กราฟนี้จึงช่วยตอบคำถามว่า “ตลาดงานฝั่ง USA ใหญ่และคึกคักกว่ากลุ่มประเทศอื่นมากแค่ไหน” ของ dataset นี้ ทั้งในมิติ จำนวนผู้จ้างงาน, จำนวนประกาศงาน, และ การสมัคร ดังนั้นในขั้นตอนถัดไป จึงเลือกเจาะลึกการวิเคราะห์ภายใน USA (โดยเฉพาะปี 2024)
